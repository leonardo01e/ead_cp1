## Script to generate plot 4 of course project 1
...
plot(dt, power_cf$Global_active_power, ylab = "Global Active Power", xlab = "", type='l')

# Voltage graph 
plot(dt, power_cf$Voltage, ylab = "Voltage", xlab = "datetime", type='l')
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lwd = 1.5, y.intersp = 0.9, cex = .7, adj = .1, bty = "n")

# Global reactive power graph
plot(dt, power_cf$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", type='l')
